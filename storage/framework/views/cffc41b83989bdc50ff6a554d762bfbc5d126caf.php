    ...
    <div class="container">
        <div class="slider">
            <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <img src="<?php echo e(@App::make('url')->to('/') . '/storage' . $event->image); ?>" alt="">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/romanfoo/public_html/website_0c6056de/resources/views/media.blade.php ENDPATH**/ ?>