<?php $__env->startSection('content'); ?>
    ...
    <div class="relative h-[85vh] bg-center bg-cover"
         style="background-image: url(<?php echo e(Vite::asset('resources/images/factory.webp')); ?>)">
        <div
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 lg:px-0">
        ...
        <img src="<?php echo e(Vite::asset('resources/images/marketing.webp')); ?>" alt="Planet Bottling Marketing" class="w-full">
    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/derarsattouf/Documents/code/personal/planet/resources/views/get-in-touch.blade.php ENDPATH**/ ?>