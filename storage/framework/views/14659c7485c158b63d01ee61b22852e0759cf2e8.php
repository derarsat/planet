<?php $__env->startSection('content'); ?>
    <img src="<?php echo e(Vite::asset('resources/images/brands-banner.webp')); ?>" alt="Planet Bottling Brands"/>
        ...
        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-grey rounded-2xl p-6 lg:p-12 grid grid-cols-3 gap-12 lg:gap-24">
                <div class="order-2 lg:order-1 flex col-span-3 lg:col-span-2 flex-col items-start justify-between">
                    ...
                    <a href="/product/<?php echo e($brand->products[0]->id); ?>"
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/derarsattouf/Documents/code/personal/planet/resources/views/brands.blade.php ENDPATH**/ ?>