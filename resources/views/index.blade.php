...
@section('content')
    <div class="grid grid-cols-1 gap-12 lg:gap-24">
        ...
        <div class="relative">
            ...
            <img src="{{ Vite::asset('resources/images/hero.webp') }}" alt="Planet Bottling Hero">
        </div>
        {{----}}
        ...
        <div class="container relative">
            <img src="{{ Vite::asset('resources/images/machine.webp') }}" alt="Planet Bottling Machines">
            <img src="{{ Vite::asset('resources/images/bubble-1.webp') }}" alt="Planet Bottling Locations"
        ...
        <div class="bg-dark container grid grid-cols-1 lg:grid-cols-2 gap-24 py-6 lg:py-0 ">
            <img src="{{ Vite::asset('resources/images/man.webp') }}" alt="Planet Bottling Factory">
            <div
        ...
        <div class="text-center grid grid-cols-1 gap-12">
            ...
            <img src="{{ Vite::asset('resources/images/map.webp') }}" alt="Planet Bottling Locations"
        ...
        <div class="bg-dark relative">
            <div class="container py-24 items-center relative ">
                ...
                <img class="absolute -top-1/3 right-0 w-[32rem] hidden lg:block"
                     src="{{ Vite::asset('resources/images/chat-bubbles.webp') }}"
