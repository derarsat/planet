...
@section('content')
    ...
    <div class="relative h-[85vh] bg-center bg-cover"
         style="background-image: url({{Vite::asset('resources/images/factory.webp')}})">
        <div
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 lg:px-0">
        ...
        <img src="{{Vite::asset('resources/images/marketing.webp')}}" alt="Planet Bottling Marketing" class="w-full">
    </div>
